...
function setup() {
  ...
  faces1[0] = createFace(0, 0, 0, 100, 100, 10);
  faces1[1] = createFace(0, 0, 0, 100, 10, 100);
  faces1[2] = createFace(0, 0, 0, 10, 100, 100);
}
...
function draw() {
  ...
  displayFace(faces1[0]);
  displayFace(faces1[1]);
  displayFace(faces1[2]);
